...
export DBNAME=ptest3-clique
export NETWORK_ID=56
#export PORT=30303
export PORT=30325
#export RPC_PORT=8545
export RPC_PORT=8567
...
then
	echo Running Miner...
	OPTS="--datadir ${DATADIR} --rpc --rpcaddr 0.0.0.0 --port ${PORT} --rpcport ${RPC_PORT} --rpcapi ${RPC_API} --rpccorsdomain \"*\" --ipcpath ${IPC_PATH} --mine --minerthreads 1 --etherbase 0 --cache 1024 --networkid ${NETWORK_ID} --password ${ETH_DBROOT}/${DBNAME}/passwd --unlock 0"
	shift
	echo Options : $OPTS
